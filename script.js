...
//             document.getElementById(place).innerHTML = arr[i][j];
//         }
//     }
// }
...
//     let plac = 'b' + x + y;
//     if (plac == 'b00') {
//         if (document.getElementById(plac).innerHTML != 'X') {
//             if (document.getElementById('b01').innerHTML == 'X') {
//                 document.getElementById('b01').innerHTML = document.getElementById(plac).innerHTML;
//                 document.getElementById(plac).innerHTML = 'X';
//             }
//             else {
//                 if (document.getElementById('b10').innerHTML == 'X') {
//                     document.getElementById('b10').innerHTML = document.getElementById(plac).innerHTML;
//                     document.getElementById(plac).innerHTML = 'X';
//                 }
//             }
//         }
...
//     if (plac == 'b10') {
//         if (document.getElementById(plac).innerHTML != 'X') {
//             if (document.getElementById('b00').innerHTML == 'X') {
//                 document.getElementById('b00').innerHTML = document.getElementById(plac).innerHTML;
//                 document.getElementById(plac).innerHTML = 'X';
//             }
//             else {
//                 if (document.getElementById('b20').innerHTML == 'X') {
//                     document.getElementById('b20').innerHTML = document.getElementById(plac).innerHTML;
//                     document.getElementById(plac).innerHTML = 'X';
//                 }
//                 else {
//                     if (document.getElementById('b11').innerHTML == 'X') {
//                         document.getElementById('b11').innerHTML = document.getElementById(plac).innerHTML;
//                         document.getElementById(plac).innerHTML = 'X';
//                     }
//                 }
//             }
...
//             }
//             else {
//                 if (document.getElementById('b21').innerHTML == 'X') {
//                     document.getElementById('b21').innerHTML = document.getElementById(plac).innerHTML;
//                     document.getElementById(plac).innerHTML = 'X';
//                 }
...
//             }
//             else {
//                 if (document.getElementById('b02').innerHTML == 'X') {
//                     document.getElementById('b02').innerHTML = document.getElementById(plac).innerHTML;
//                     document.getElementById(plac).innerHTML = 'X';
//                 }
//                 else {
//                     if (document.getElementById('b11').innerHTML == 'X') {
...
//             }
//             else {
//                 if (document.getElementById('b12').innerHTML == 'X') {
//                     document.getElementById('b12').innerHTML = document.getElementById(plac).innerHTML;
//                     document.getElementById(plac).innerHTML = 'X';
//                 }
//                 else {
//                     if (document.getElementById('b01').innerHTML == 'X') {
...
//                         document.getElementById(plac).innerHTML = 'X';
//                     }
//                     else if (document.getElementById('b21').innerHTML == 'X') {
//                         document.getElementById('b21').innerHTML = document.getElementById(plac).innerHTML;
//                         document.getElementById(plac).innerHTML = 'X';
//                     }
//                 }
...
//             }
//             else {
//                 if (document.getElementById('b22').innerHTML == 'X') {
//                     document.getElementById('b22').innerHTML = document.getElementById(plac).innerHTML;
//                     document.getElementById(plac).innerHTML = 'X';
//                 }
//                 else {
//                     if (document.getElementById('b11').innerHTML == 'X') {
...
//         for (let j = 0; j < 3; j++) {
//             let place = 'b' + i.toString() + j.toString();
//             if(document.getElementById(place).innerHTML != matrix[i][j])
//                 return false;
//         }
//     }
//     alert('winner');
...
function print() {
    ...
    for (let i = 0; i < 3; i++) {
        for (let j = 0; j < 3; j++) {
            ...
            str=getImg(arr3[i][j]);
            document.getElementById(place).innerHTML = str;
            document.getElementById(place).value = arr3[i][j];
        }
    }
}
function getImg(num)
